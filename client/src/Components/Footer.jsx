    ...
    <AppBar position="static" sx={{backgroundColor: '#394044', paddingLeft:'8%', paddingRight:'8%' }}>
      <Container maxWidth="xl" sx={{ paddingTop:'0', paddingBottom: '0', margin:'0'}}>
        <Toolbar sx={{ mr: 2, display: { xs: 'none', md: 'flex' } }}>
          ...
          >
            Copyright 2022. Loner All Rights Reserved.
          </Typography>
        ...
        <Box sx={{ display: { xs: 'flex', md: 'none' }, position:'relative', left:'15%' }}>
            Copyright 2022. Loner All Rights Reserved. 
        </Box>
        
        
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, position:'relative', left:'8%'}}>
                
                {pages.map((page) => (
                <Button
                    sx={{color: 'white', display: 'flex', textDecoration:'underline'}}
                >
                    {page}
                </Button>
                ))}
